...
export default function Navbar() {
  return (
   <header className="md:sticky top-0 z-10 h-30">
      <div className="container mx-auto flex place-content-centerflex-wrap p-5 md:flex-row gap-10">
        <a className='flex flex-row gap-5 '>
          <img src={Logo} alt="Logo" className='logo'/>
          
          <p className='text-gray-200 mr-4 ml-4 text-2xl'>Portfólio pessoal</p>
        </a>
        ...
        <a
          href="#contact"
          className="inline-flex p-7 items-center bg-gray-200 border-solid border-black py-1 px-3 focus:outline-none hover:bg-gray-700 rounded-2xl mt-4 md:mt-0">
          Contate-me
